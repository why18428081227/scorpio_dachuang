...
if("TRUE" STREQUAL "TRUE")
  set(spark_rtabmap_SOURCE_PREFIX /home/glc/catkin_ws/src/scorpio_app/spark_rtabmap)
  set(spark_rtabmap_DEVEL_PREFIX /home/glc/catkin_ws/devel)
  ...
  set(spark_rtabmap_INSTALL_PREFIX /home/glc/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'spark_rtabmap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/glc/catkin_ws/src/scorpio_app/spark_rtabmap/${idir}'.  ${_report}")
    endif()
